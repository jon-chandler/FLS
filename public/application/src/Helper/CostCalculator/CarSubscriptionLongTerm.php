 ...
 * Long Term
 */
class CarSubscriptionLongTerm extends CostCalculator
{
    /**
    ...
    {
        $vehicleCosts = [];
        $runningCosts = $this->con->fetchAssoc('SELECT parking_home, subscription_fee FROM insurance_price WHERE insurance_group = ?', [$vehicle['InsuranceGroup']]);
        ...
        if ($runningCosts) {
            ...
            $subscriptionFee = (float) $runningCosts['subscription_fee'];
        }
