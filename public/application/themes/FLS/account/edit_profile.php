<?php 
    ...
    $name = "{$profile->getAttribute('firstName')} {$profile->getAttribute('lastName')}";
 ?>
<main>
<section class="fls-profile">
    <div class="user-info">
    
        <h1 class="section-header"><?php echo $name; ?></h1>
        <div class="image-container">
            <a href="/account/avatar"><img src="<?php echo $profile->getUserAvatar()->getPath(); ?>" title="Edit photo" class="profile-img" /></a>
        </div>
